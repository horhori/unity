...
{
    public static bool IsInScreen(Transform transform,
        bool checkHorizontal, bool checkVertical)
    {
        return IsInScreen(transform, checkHorizontal, checkVertical,
            (-8.5f, 8.5f), (-4.5f, 4.5f));
    }

    public static bool IsInScreen(Transform transform,
        bool checkHorizontal, bool checkVertical,
        (float left, float right) hori, (float bottom, float top) vert)
    {
